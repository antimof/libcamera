...
const ControlInfoMap::Map ipaControls{
	...
	{ &controls::AeMaxShutter, ControlInfo(0, 66666) },
...
void IpaBase::applyControls(const ControlList &controls)
{
	...
	for (auto const &ctrl : controls) {
		...
		case controls::AE_MAX_SHUTTER: {
			...
			agc->setMaxShutter(ctrl.second.get<int32_t>() * 1.0us);
			libcameraMetadata_.set(controls::AeMaxShutter, ctrl.second.get<int32_t>());
			break;
		}
